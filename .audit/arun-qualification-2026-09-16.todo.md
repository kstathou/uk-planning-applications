...
- [x] Implement each green unit and verify it before continuing.
...
- [ ] Run tests, coverage, lint, format, configured mypy, build, and repository verification gates after the review remediation.
