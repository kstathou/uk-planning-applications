...
| Devon County Council | `planning.devon.gov.uk/` | Custom register | The exact advanced form, 30-day received and determined searches, complete outstanding search, singleton detail and appeal responses, and metadata-only documents were verified. A persisted bootstrap produced 67 applications. See `authorities/devon.md`. |
