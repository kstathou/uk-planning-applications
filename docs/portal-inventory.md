...
| Dorset | `planning.dorsetcouncil.gov.uk` plus the Explorer fixture source | ASP.NET and Telerik statutory register | A 30-day received query, unrestricted outstanding query, 1,436 current detail records, exact document metadata, and zero-network terminal rerun were verified without attachment bodies. See `authorities/dorset.md`. |
