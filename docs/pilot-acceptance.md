...
| Camden | Verified | Detail and 16-row document index recorded; comments open | Fixture-only | Open | Open |
| Haringey | Verified | JavaScript detail, comment, and file tabs recorded | Browser-only | Open | Open |
| Devon County Council | Verified | Discovery and detail routes recorded; child sections partial | Fixture-only | Open | Open |
| Peak District National Park Authority | Verified | Migrated discovery and detail routes recorded; child sections partial | Fixture-only | Open | Open |
| Arun | Verified | Bounded received-date route, result cap, detail, and document index recorded | Fixture-only | Open | Open |
