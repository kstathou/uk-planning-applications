...
from yimby.authorities.camden import LEGACY_CAMDEN_PACKAGE as CAMDEN_PACKAGE
...
if __name__ == "__main__":
    message = "Retired portal qualifier. Use scripts/qualify_camden.py (official API)."
